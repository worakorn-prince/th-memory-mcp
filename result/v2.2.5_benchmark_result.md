...
- Project: v2.2.5 (22da4e4)
- Benchmark spec: v1.0
- Run mode: warm
- Timestamp: 2026-08-31T17:14:48.817Z
...
## E.performance
- operations: 9
- latency[remember](ms): min=0 mean=3.5500 p95=4.1500 p99=52.0300 max=64
- latency[recall](ms): min=0 mean=0.4500 p95=1 p99=1 max=1
- latency[getContext](ms): min=0 mean=0.3500 p95=1 p99=1 max=1
- latency[retrieve](ms): min=0 mean=0.3000 p95=1 p99=1 max=1
- latency[createMemory](ms): min=0 mean=0.4500 p95=1 p99=1 max=1
- latency[updateMemory](ms): min=1 mean=4.4000 p95=7.5000 p99=45.5000 max=55
- latency[mergeMemory](ms): min=1 mean=6.4500 p95=46.2000 p99=49.2400 max=50
- latency[linkMemory](ms): min=1 mean=3.6500 p95=4.3000 p99=39.2600 max=48
- latency[forget](ms): min=0 mean=2.7500 p95=3.0000 p99=33.4000 max=41
- notes: warmup=10 iterations=20 (warm only; cold not yet implemented)

## F.scalability
- memoriesInserted: 500
- memoriesPerSec: 588.9282
- dbSizeMB: 6.2379
- mbPer1kMemories: 12.4759
- peakRssMB: 74.5977
- rssGrowthMB: 0.0039
- cpuUserMs: 156
- cpuSysMs: 172
...
- operations: 9
- samples: 20
- latency[remember](ms): min=0 mean=0.9500 p95=1 p99=1 max=1
- latency[recall](ms): min=4 mean=4.6000 p95=6 p99=6 max=6
- latency[getContext](ms): min=8 mean=9.5000 p95=11.0500 p99=11.8100 max=12
- latency[retrieve](ms): min=7 mean=8.0500 p95=10.0500 p99=10.8100 max=11
- latency[createMemory](ms): min=0 mean=0.7500 p95=1.0500 p99=1.8100 max=2
- latency[updateMemory](ms): min=2 mean=3.5000 p95=5 p99=5 max=5
- latency[mergeMemory](ms): min=3 mean=4.1000 p95=5.0500 p99=5.8100 max=6
- latency[linkMemory](ms): min=2 mean=2.7000 p95=3.0500 p99=3.8100 max=4
- latency[forget](ms): min=1 mean=2.3500 p95=3 p99=3 max=3
