...
- Project: v2.2.6 (3fc1b8e)
- Benchmark spec: v1.0
- Run mode: warm
- Timestamp: 2026-08-31T17:25:09.078Z
...
## E.performance
- operations: 9
- latency[remember](ms): min=0 mean=3.2000 p95=3.6000 p99=43.1200 max=53
- latency[recall](ms): min=0 mean=0.5500 p95=1 p99=1 max=1
- latency[getContext](ms): min=0 mean=0.4500 p95=1 p99=1 max=1
- latency[retrieve](ms): min=0 mean=0.4000 p95=1 p99=1 max=1
- latency[createMemory](ms): min=0 mean=0.8500 p95=1 p99=1 max=1
- latency[updateMemory](ms): min=1 mean=4.9500 p95=8.4000 p99=44.8800 max=54
- latency[mergeMemory](ms): min=1 mean=6.6000 p95=43.0500 p99=43.8100 max=44
- latency[linkMemory](ms): min=1 mean=4.4500 p95=5.2500 p99=39.4500 max=48
- latency[forget](ms): min=0 mean=0.8500 p95=1.0500 p99=1.8100 max=2
- notes: warmup=10 iterations=20 (warm only; cold not yet implemented)

## F.scalability
- memoriesInserted: 500
- memoriesPerSec: 549.4505
- dbSizeMB: 6.2615
- mbPer1kMemories: 12.5229
- peakRssMB: 74.8633
- rssGrowthMB: 0
- cpuUserMs: 250
- cpuSysMs: 250
...
- operations: 9
- samples: 20
- latency[remember](ms): min=0 mean=1.0500 p95=2.0500 p99=2.8100 max=3
- latency[recall](ms): min=3 mean=5.0500 p95=6.1000 p99=7.6200 max=8
- latency[getContext](ms): min=8 mean=10.1500 p95=13 p99=13 max=13
- latency[retrieve](ms): min=6 mean=8.5500 p95=12.1500 p99=14.4300 max=15
- latency[createMemory](ms): min=0 mean=0.8000 p95=1 p99=1 max=1
- latency[updateMemory](ms): min=2 mean=3.4000 p95=5.0500 p99=5.8100 max=6
- latency[mergeMemory](ms): min=2 mean=3.7000 p95=6.0500 p99=6.8100 max=7
- latency[linkMemory](ms): min=1 mean=2.5000 p95=4.0500 p99=4.8100 max=5
- latency[forget](ms): min=2 mean=2.3500 p95=3.0500 p99=3.8100 max=4
